package com.jiechu.jiechupro.view.recyclerview.Divider;
...
public class BaseItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public BaseItemDecoration(Context mContext, int res) {
        ...
        this.mHeight = mDivider.getIntrinsicHeight() <= 0 ? dp2px(7) : mDivider.getIntrinsicHeight();
        this.mWidth = mDivider.getIntrinsicWidth() <= 0 ? dp2px(7) : mDivider.getIntrinsicWidth();
    }
