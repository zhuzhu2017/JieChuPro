package com.jiechu.jiechupro.view.recyclerview.AutoLoad;
...
import com.jiechu.jiechupro.view.recyclerview.DefaultHeaderAndFooterCreator.DefaultAutoLoadFooterCreator;
    ...
    public void onScrollStateChanged(int state) {
        ...
        if (state == RecyclerView.SCROLL_STATE_IDLE && !mIsLoading && mLoadMoreEnable && mLoadView != null) {
            ...
            if (layoutManager.getChildCount() > 0
                ...
                mIsLoading = true;
                if (GONE == mLoadView.getVisibility()) {
